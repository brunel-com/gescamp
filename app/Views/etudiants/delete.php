...
<div class="container py-5">
  ...
  <div class="col-md-5 mx-auto">
    <div class="card shadow-sm mt-4">
      <form action="/etudiants/delete" method="post" class="card-body">
        <?= csrf_field() ?>
        <input type="hidden" name='id' value="<?= esc($obj['id'])?>" />
        <h5 class="card-title">Confirmer la suppression</h5>
        <p class="card-text">Voulez vous vraiment supprimer cet étudiant ? Notez que cette action est irreversible.</p>
